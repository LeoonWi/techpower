...
type User struct {
	...
	Balance     float64         `json:"balance,omitempty" bson:"balance,omitempty"`       // only master
	Commission  float64         `json:"commission,omitempty" bson:"commission,omitempty"` // only master
